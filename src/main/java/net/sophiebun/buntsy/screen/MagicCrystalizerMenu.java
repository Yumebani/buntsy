...
public class MagicCrystalizerMenu extends AbstractContainerMenu {
    ...
    private final MagicCrystalizerBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    protected MagicCrystalizerMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(3));
    }

    public MagicCrystalizerMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.MAGIC_CRYSTALIZER_MENU.get(), pContainerId);
        checkContainerSize(inv, 9);
        blockEntity = ((MagicCrystalizerBlockEntity) entity);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.MAGIC_CRYSTALIZER.get());
    }
