...
public class FairyOfferingBenchMenu extends AbstractContainerMenu {

    private final FairyOfferingBenchBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    protected FairyOfferingBenchMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.FAIRY_OFFERING_BENCH.get());
    }
