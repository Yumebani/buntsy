...
public class ThreadReelerMenu extends AbstractContainerMenu {

    private final ThreadReelerBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    protected ThreadReelerMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.THREAD_REELER.get());
    }
