...
public class GrindingWheelMenu extends AbstractContainerMenu {
    ...
    private final GrindingWheelBlockEntity blockEntity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.GRINDING_WHEEL.get());
    }
