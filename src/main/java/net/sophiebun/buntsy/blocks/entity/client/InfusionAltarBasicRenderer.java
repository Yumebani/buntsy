...
public class InfusionAltarBasicRenderer implements BlockEntityRenderer<InfusionAltarBasicBlockEntity> {

    public InfusionAltarBasicRenderer(BlockEntityRendererProvider.Context context){
    }

    @Override
    public void render(InfusionAltarBasicBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
